...
import { TextBalloonsDemo } from '@/fancy/components/text/text-balloons-demo';
...
export const Html = () => {
  ...
  useEffect(() => {
    // Generate random delays for the glitch effect on the client side
  ...
  return (
    <div className="h-svh">
      ...
      <Canvas
        flat
        gl={async (props) => {
          const renderer: THREE.WebGPURenderer = new THREE.WebGPURenderer(props as any);
          await renderer.init();
          return renderer;
        }}
      >
